...
import arcjetDefault, { detectBot, shield } from "./arcjet";
import { request } from "@arcjet/next";
import { stripe } from "./stripe";

// Handle optional arcjet - create a mock if not configured
const arcjet = arcjetDefault || {
  withRule: () => ({
    withRule: () => ({
...
export async function CreateJobseekerForm(
...
export async function EditJobPost(
  value: z.infer<typeof jobPostSchema>,
  jobId: string
) {
  await User();
